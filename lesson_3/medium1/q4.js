...
becomes full, any new elements will displace the oldest elements in the buffer.
...
// The first argument mutates the original buffer
arr1 = [1,2,3,4]
console.log(addToRollingBuffer1(arr1, 4, 5));
console.log(arr1); // => returns [2,3,4,5]

// The second argument mutates the original buffer
arr2 = [1,2,3,4]
console.log(addToRollingBuffer2(arr2, 4, 5));
