...
and returns a string representing that angle in degrees, minutes, and seconds. You should use a degree
symbol (˚) to represent degrees, a single quote (') to represent minutes, and a double quote (") to
represent seconds. There are 60 minutes in a degree, and 60 seconds in a minute.
*/

let dms = num => {
  let degree = parseInt(num);
  let minutes = (num - degree) * 60;
  ...
  console.log(`${degree}°${minutes}'${seconds}`);
};
